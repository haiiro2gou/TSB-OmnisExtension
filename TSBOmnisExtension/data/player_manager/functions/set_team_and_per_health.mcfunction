...
# 割合をもとにチーム振り分け
    ...
    execute if score $Health Temporary matches 00..34 if entity @s[tag=Believe.Omnis] run team join Omnis.LowHP
    execute if score $Health Temporary matches 35..79 if entity @s[tag=Believe.Omnis] run team join Omnis.MedHP
    execute if score $Health Temporary matches 80.. if entity @s[tag=Believe.Omnis] run team join Omnis.HighHP
