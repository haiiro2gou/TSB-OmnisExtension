...
# 各神固有処理
    ...
    execute if entity @s[tag=Believe.Omnis] run function lib:message/god/omnis/unbelieve2
    execute if entity @s[tag=Believe.Omnis] run function player_manager:god/omnis/unbelieve
# 全装備を再チェック
