...
# ウィ＝キ
    data modify storage player_manager:god OfferingData.Omnis.GodName set value "オムニス"
    data modify storage player_manager:god OfferingData.Omnis.Items set value []
    data modify storage player_manager:god OfferingData.Omnis.Items append value {Item:{id:"minecraft:lava_bucket"},Amount:[1,1],Name:'{"translate":"item.minecraft.lava_bucket"}'}
    data modify storage player_manager:god OfferingData.Omnis.Items append value {Item:{id:"minecraft:netherite_ingot"},Amount:[1,2],Name:'{"translate":"item.minecraft.netherite_ingot"}'}
