...
# 割合をもとにチーム振り分け
    ...
    execute if score $Health Temporary matches 00..34 if entity @s[tag=Believe.Omnia] run team join Omnia.LowHP
    execute if score $Health Temporary matches 35..79 if entity @s[tag=Believe.Omnia] run team join Omnia.MedHP
    execute if score $Health Temporary matches 80.. if entity @s[tag=Believe.Omnia] run team join Omnia.HighHP
