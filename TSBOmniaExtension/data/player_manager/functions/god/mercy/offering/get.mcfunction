...
# 取得
    ...
    execute if score @s InSubArea matches 6 run data modify storage player_manager:god TargetOfferingData set from storage player_manager:god OfferingData.Omnia
# 未設定の場合設定する
