...
# セット
    ...
    execute if score @s InSubArea matches 6 run data modify storage player_manager:god OfferingData.Omnia set from storage player_manager:god TargetOfferingData
# リセット
