...
# 各神固有処理
    ...
    execute if entity @s[tag=Believe.Omnia] run function lib:message/god/omnia/unbelieve2
    execute if entity @s[tag=Believe.Omnia] run function player_manager:god/omnia/unbelieve
# 全装備を再チェック
