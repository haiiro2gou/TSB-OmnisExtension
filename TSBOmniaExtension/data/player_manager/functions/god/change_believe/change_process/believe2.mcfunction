...
# 各神固有処理
    ...
    execute if score @s InSubArea matches 6 run function lib:message/god/omnia/believe2
    execute if score @s InSubArea matches 6 run function player_manager:god/omnia/believe
# 全装備を再チェック
